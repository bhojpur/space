# Bhojpur Space - R-tree Library

It provides an in-memory R-Tree implementation for Go. It's designed for Tile and is optimized
for fast rect inserts and replacements.
...
```sh
$ go get -u github.com/bhojpur/space/pkg/utils/rtree
```
