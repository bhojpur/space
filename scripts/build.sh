...
if [ -d ".git" ]; then
	...
	LDFLAGS="$LDFLAGS -X github.com/bhojpur/space/pkg/core.Version=${VERSION}"
	LDFLAGS="$LDFLAGS -X github.com/bhojpur/space/pkg/core.GitSHA=${GITSHA}"
fi
LDFLAGS="$LDFLAGS -X github.com/bhojpur/space/pkg/core.BuildTime=$(date +%FT%T%z)"
